...
<section class="bg-white dark:bg-gray-900 hero hero-image ">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 ">
        ...
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-4xl dark:text-white">Welcome to the website Cities Of The World </h1>
